...
<body>
    ...
    <div class="page-container page-navigation-toggled page-container-wide">
        ...
        <div class="page-content">
            ...
            {{-- START BREADCRUMB --}}
            <ul class="breadcrumb">
                <li class="active">Extra Service Report</li>
            </ul>
            {{--  END BREADCRUMB  --}}
                                                ...
                                                <table id="checkintable" class="table table-striped table-bordered" style="width:100%">
                                                        <thead>
                                                                <tr>
                                                                        ...
                                                                        <th style="width:15%" id="f_date"></th>
                                                            ...
                                                            <tr>
                                                                    ...
                                                                    <th style="width:40%">@lang('report.extraservicename')</th>
                                                                  
                                                                    <th style="width:15%">@lang('report.qty')</th>
...
var inserturl="{{ url('extraitemreportdata')}}";
...
<script src="{{ URL::asset('resources/js/myjs/extraservicereport.js') }}">
</script>
