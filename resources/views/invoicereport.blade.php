                                    ...
                                    <form class="form-horizontal" id="mainform" name="mainform">
                                        <div class="row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-1">
                                                        <label>@lang('report.visitername')</label>
                                                    </div>
                                                    <div class="col-sm-2">
                                                            <select id="visitorname" name="visitorname" class="form-control fstdropdown-select"  required>
                                                ...
                                                <table id="checkintable" class="table table-striped table-bordered" style="width:100%">
                                                        <thead>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th style="width:15%">@lang('report.amount')</th>
...
var getallvisiter="{{ url('getallvisitorname') }}";
...
<script src="{{ URL::asset('resources/js/myjs/invoicereport.js') }}">
</script>
