            ...
            success: function(data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    if (data[i].roomdata.length > 0) {
                        ...
                        html += '<a class="categoryname" caterate="' + data[i].rate + '"  id="catname_' + data[i].cateid + '"><b>' + data[i].catname + '</b></a><br>';
                        // html += '<br>';
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    if (flag == 1) {
                        // $(this).remove();
                        html += '<button type="button"  class="roomalocate btn btn-sm  btn-xs  btn-info" getid="btnroom_' + data[i].id + '"  id="freeroom_' + data[i].id + '" name="' + rate + '" >' + data[i].roomno + '</button> &nbsp;';
                    } else {
                        html += '<button type="button"  class="roomalocate btn btn-sm  btn-xs  btn-primary" getid="btnroom_' + data[i].id + '"  id="freeroom_' + data[i].id + '" name="' + rate + '" >' + data[i].roomno + '</button> &nbsp;';
                    }
